...
Esta pasta reúne os principais documentos técnicos, análises e relatórios do projeto Dog Food Nutrition Catalog.
...
- use esta documentação como fonte de referência para arquitetura, regras e decisões técnicas;
- mantenha os documentos atualizados sempre que houver mudança relevante no fluxo ou nas validações;
- evite registrar informações desatualizadas ou promessas de funcionamento não comprovadas.
